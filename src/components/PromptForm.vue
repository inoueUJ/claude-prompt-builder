...
// ⚡ Bolt Optimization: Removed getFieldValue to avoid method calls in template
// Method calls in templates (especially in v-for loops) execute on every re-render.
// Replaced with direct access to promptStore.formData[field.key] in the template.
