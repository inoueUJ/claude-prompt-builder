...
// ⚡ Bolt Optimization: Replace method calls and inline handlers in template with direct v-model binding
// Since getFieldValue and updateField were called/defined inside a v-for on every render/keystroke,
// they caused unnecessary function allocations and Vue virtual DOM thrashing.
// Direct v-model binding to the store state is much more performant.
