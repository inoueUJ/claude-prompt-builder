      ...
      <div v-for="(groupFields, groupName) in groupedFields" :key="groupName" class="form-group">
        ...
        <div class="field-container">
          <div v-for="field in groupFields" :key="field.key" class="field-wrapper">
            ...
            <!-- ⚡ Bolt Optimization: Replace manual :value/@input with v-model -->
            <!-- Using v-model defers state updates during IME composition (crucial for Japanese input), -->
            <!-- which prevents excessive re-renders and improves perceived performance while typing. -->
            <textarea
