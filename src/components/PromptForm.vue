...
// ⚡ Bolt Optimization: Track IME composition state
// Prevent excessive Pinia store updates and re-renders while the user is actively
// composing characters (e.g., using a Japanese IME). Updates are only flushed
