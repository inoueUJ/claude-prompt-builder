...
// ⚡ Bolt Optimization: Use direct property binding instead of method calls in templates to allow Vue's compiler to statically analyze dependencies and prevent unnecessary function execution on every render cycle.
