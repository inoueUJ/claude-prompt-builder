...
// ⚡ Bolt Optimization: Avoid method calls for state bindings in templates
// Direct property bindings (e.g. :value="promptStore.formData[field.key]") allow Vue's compiler
