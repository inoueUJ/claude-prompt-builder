...
// Calling a method in the template (e.g., :value="getFieldValue(field.key)")
// executes on every single component re-render (like on every keystroke in any input).
// Accessing the reactive store property directly (:value="promptStore.formData[field.key]")
// prevents these redundant method invocations and improves rendering performance.
