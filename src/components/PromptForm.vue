      ...
      <div v-for="(groupFields, groupName) in groupedFields" :key="groupName" class="form-group">
        ...
        <div class="field-container">
          <div v-for="field in groupFields" :key="field.key" class="field-wrapper">
            ...
            <!--
              ⚡ Bolt Optimization: Use v-model for IME users
              Prefer v-model over manual :value and @input bindings to automatically defer state updates
              during IME composition (like Japanese text input). This prevents excessive store updates
              and component re-renders while the user is still composing characters.
            -->
            <textarea
