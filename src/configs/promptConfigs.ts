...
参考事例：パタゴニア環境キャンペーン、スターバックス限定戦略`,
      ...
      },
      {
        ...
        label: '制約条件',
        placeholder:
          'グリーンウォッシュ回避、データ根拠明記、多様性配慮、アクセシビリティ対応、炎上リスク回避',
        type: 'textarea',
        group: '⚙️ 制約・出力設定',
      },
      {
        ...
        label: '出力形式',
        placeholder:
          'キャンペーン概要書 + クリエイティブ案 + 実施スケジュール + 予算配分 + KPI設定 + リスク評価',
        type: 'text',
        group: '⚙️ 制約・出力設定',
      },
      {
    ...
    fields: [
      {
        key: 'role',
        label: '役割',
        placeholder: 'シニアソフトウェアエンジニア（コードレビュー専門）',
        type: 'text',
        required: true,
        group: '🎭 基本設定',
      },
      ...
      },
      {
        key: 'thinking',
        label: 'レビュー観点',
        placeholder: 'パフォーマンス、保守性、セキュリティ',
        type: 'textarea',
        group: '🔍 レビュー設定',
      },
      {
        key: 'instructions',
        label: 'メイン指示',
        placeholder: 'コードレビューを実施し、改善提案をしてください',
        type: 'textarea',
        required: true,
        group: '🔍 レビュー設定',
      },
    ...
    fields: [
      {
        key: 'role',
        label: '役割',
        placeholder: 'ソリューションアーキテクト（大規模システム設計専門）',
        type: 'text',
        required: true,
        group: '🎭 基本設定',
      },
      ...
      },
      {
        key: 'thinking',
        label: '設計アプローチ',
        placeholder: 'マイクロサービス、DDD、イベント駆動',
        type: 'textarea',
        group: '🏗️ 設計設定',
      },
      {
        key: 'instructions',
        label: 'メイン指示',
        placeholder: 'システムアーキテクチャを設計してください',
        type: 'textarea',
        required: true,
        group: '🏗️ 設計設定',
      },
      {
        key: 'constraints',
        label: '制約条件',
        placeholder: '予算制限、移行期間、ダウンタイム制限',
        type: 'textarea',
        group: '⚙️ 制約・出力設定',
      },
      {
        key: 'output_format',
        label: '出力形式',
        placeholder: 'アーキテクチャ図、技術選定理由、移行計画',
        type: 'text',
        group: '⚙️ 制約・出力設定',
      },
      {
    ...
    fields: [
      {
        key: 'role',
        label: '役割',
        placeholder: 'テックリード兼メンター（技術調査専門）',
        type: 'text',
        required: true,
        group: '🎭 基本設定',
      },
      ...
      },
      {
        key: 'thinking',
        label: '学習アプローチ',
        placeholder: '段階的学習、実践重視、理論と実践の組み合わせ',
        type: 'textarea',
        group: '📚 学習設定',
      },
      {
        key: 'instructions',
        label: 'メイン指示',
        placeholder: '技術調査と学習ロードマップを作成してください',
        type: 'textarea',
        required: true,
        group: '📚 学習設定',
      },
      {
        key: 'specialization',
        label: '特化情報',
        placeholder: '学習対象、現在スキル、時間制約、実践応用目標',
        type: 'textarea',
        group: '📚 学習設定',
      },
      {
        key: 'constraints',
        label: '制約条件',
        placeholder: '学習時間、無料リソース優先、業務並行',
        type: 'textarea',
        group: '⚙️ 制約・出力設定',
      },
      {
        key: 'output_format',
        label: '出力形式',
        placeholder: '学習ロードマップ、技術調査レポート、実践課題',
        type: 'text',
        group: '⚙️ 制約・出力設定',
      },
    ],
    ...
    fields: [
      {
        key: 'role',
        label: '役割',
        placeholder: 'DevOpsエンジニア（プロセス改善専門）',
        type: 'text',
        required: true,
        group: '🎭 基本設定',
      },
      ...
      },
      {
        key: 'specialization',
        label: '特化情報',
        placeholder: '現在プロセス、課題、チーム構成、技術環境',
        type: 'textarea',
        group: '⚡ プロセス設定',
      },
      {
    ...
    fields: [
      {
        key: 'role',
        label: '役割',
        placeholder: 'シニアデバッグエンジニア（障害対応専門）',
        type: 'text',
        required: true,
        group: '🎭 基本設定',
      },
      ...
      },
      {
        key: 'instructions',
        label: 'メイン指示',
        placeholder: '障害原因を分析し、解決策を提案してください',
        type: 'textarea',
        required: true,
        group: '🐛 デバッグ設定',
      },
      {
        key: 'specialization',
        label: '特化情報',
        placeholder: '問題詳細、エラーログ、システム環境、最近の変更',
        type: 'textarea',
        group: '🐛 デバッグ設定',
      },
      {
    ...
    fields: [
      {
        key: 'role',
        label: '役割',
        placeholder: 'UXデザイナー（ユーザビリティ改善専門）',
        type: 'text',
        required: true,
        group: '🎭 基本設定',
      },
      ...
      },
      {
        key: 'specialization',
        label: '特化情報',
        placeholder: '現在指標、ユーザー課題、ターゲット、競合分析',
        type: 'textarea',
        group: '🎨 UX設定',
      },
      {
      ...
      },
      {
        key: 'output_format',
        label: '出力形式',
        placeholder: 'ユーザージャーニー、改善案、A/Bテスト計画',
        type: 'text',
        group: '⚙️ 制約・出力設定',
      },
    ],
    ...
    fields: [
      {
        key: 'role',
        label: '役割',
        placeholder: 'AIプロンプトエンジニア（LLM最適化専門）',
        type: 'text',
        required: true,
        group: '🎭 基本設定',
      },
      ...
      },
      {
        key: 'specialization',
        label: '特化情報',
        placeholder: '対象AIモデル、プロンプト目標、評価基準、出力構造',
        type: 'textarea',
        group: '🤖 AI設定',
      },
      {
      ...
      },
      {
        key: 'output_format',
        label: '出力形式',
        placeholder: '完成プロンプト、テストケース、統合手順',
        type: 'text',
        group: '⚙️ 制約・出力設定',
      },
    ],
  ...
  tool_development: {
    fields: [
      ...
      },
      {
        key: 'goals',
        label: '目標',
        placeholder: '特定のタスクを自動化するツールの開発',
        type: 'textarea',
        group: '🎭 基本設定',
      },
      {
      ...
      },
      {
        key: 'specialization',
        label: '特化情報',
        placeholder: 'ツールの要件、プログラミング言語、ライブラリ',
        type: 'textarea',
        group: '🔧 開発設定',
      },
      {
        key: 'output_format',
        label: '出力形式',
        placeholder: 'ソースコード、README.md、使用方法',
        type: 'text',
        group: '⚙️ 制約・出力設定',
      },
    ],
    ...
    fields: [
      {
        key: 'role',
        label: '役割',
        placeholder: 'データサイエンティスト（分析・可視化専門）',
        type: 'text',
        required: true,
        group: '🎭 基本設定',
      },
      ...
      },
      {
        key: 'tech_stack',
        label: '技術スタック',
        placeholder: 'Python, Pandas, Plotly, Jupyter',
        type: 'text',
        group: '📊 分析設定',
      },
      {
      ...
      },
      {
        key: 'instructions',
        label: 'メイン指示',
        placeholder: 'データ分析と可視化を実施してください',
        type: 'textarea',
        required: true,
        group: '📊 分析設定',
      },
      {
        key: 'output_format',
        label: '出力形式',
        placeholder: '分析レポート、ダッシュボード、予測モデル',
        type: 'text',
        group: '⚙️ 制約・出力設定',
      },
      {
